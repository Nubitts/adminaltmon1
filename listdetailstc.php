...
$Query = "select ticket, ciclo, tabla, fletero, neto, descto, liquido, Entrada, salida, quema, tipo from vmovements where Key_Hm = " . $keyhm . " " . $filterc . " order by entrada asc";
$Query1 = "";
