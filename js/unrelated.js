      ...
      .controller("hrController", ["$scope", "$http", function($scope, $http) {
        ...
        $scope.init = function() {
          ...
          $http.post("./dataus.php", angular.toJson($scope.hr1))
            ...
            $http.post('./listunrelated.php', angular.toJson($scope.hr1))
                .then(function (respuesta) {
        ...
        $scope.detailsm = function (keyhm, producer) {
          ...
          else
          {
            $scope.hr1.filter = ""
              ...
              $http.post('./listdetunrel.php', angular.toJson($scope.hr1))
                .then(function (respuesta) {
 ...
 table = new Tabulator("#movements", {
   ...
   movableColumns: true,
    ...
    columns:[                 //define the table columns
        ...
        {title: "Descuento", field: "descto"},
        {title: "Liquido", field: "liquido" },
    ],  
 });
  ...
  document.getElementById("download-xlsx").addEventListener("click", function(){
      table.download("xlsx", "unrelated_mov.xlsx", {sheetName:"movimientos"});
  });
...
function tabdetails(datos) {
 ...
 table1 = new Tabulator("#details", {
    ...
    columns:[                 //define the table columns
        ...
        {title: "Neto", field: "neto" },
        {title: "Descuento", field: "descto", sorter:"number" },
        {title: "Liquido", field: "liquido", sorter:"number" },
  ...
  document.getElementById("download-xlsx1").addEventListener("click", function(){
      table1.download("xlsx", "detailunrel.xlsx", {sheetName:"movimientos"});
  });
